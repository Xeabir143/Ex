...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      const loadingMessage = await api.sendMessage("loading a random video frm horny station, please wait...", event.threadID);

      const pageId = "HORNYSTATION2"; // Replace with the ID or username of the Facebook page ("naos011" in this case)
      const accessToken = "EAAD6V7os0gcBOx6n4Mq5OnOnfHzZAOWGxNTDLuSaMchEHh38KWg0aKRjrE8ZBrOKZA2TesFOD0siTtDQkqOhrj0IIdXZATghF7Dj2uHvQU1H8ZBVpK19rNk6NBFZAx0Hu9e7NUT3hLUpkA0leyChiFeGLv5rpG4C95CPWjpwcMwDDEULQVPnlCfHkMzPg0llCF8QZDZD";// Replace with your token
